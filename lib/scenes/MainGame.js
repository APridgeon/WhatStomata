...
export default class MainGame extends Phaser.Scene{
    ...
    create() {
        ...
        this.meristemoid2 = this.add.sprite(350,155, 'mmc').setScale(5).setOrigin(0,0).setInteractive();
        this.meristemoid3 = this.add.sprite(315,85, 'meristemoid2').setScale(5).setOrigin(0,0).setVisible(false);
        this.meristemoid2 = this.add.sprite(315,85, 'meristemoid2').setScale(5).setOrigin(0,0).setInteractive().setVisible(false);
        ...
        this.meristemoid2.on('pointerup', function (event) { //once you click off it goes back to normal
            this.meristemoid2.clearTint();
            this.meristemoid2.destroy();
